...
class TraderTest(TestCase):
    ...
    def test_create_sell_order_when_price_jumps(self):
        ...
        self._trader._create_sell_order(100, 1000, Trader.REASON_PRICE_JUMP)
        self._mox.ReplayAll()
        self._trader._create_orders_when_price_jumps(price_stream, first_currency_balance_stream,
    ...
    def test_create_buy_order_when_price_jumps(self):
        ...
        self._trader._create_buy_order(100, 1000, Trader.REASON_PRICE_JUMP)
        self._mox.ReplayAll()
        self._trader._create_orders_when_price_jumps(price_stream, first_currency_balance_stream,
                                                     second_currency_balance_stream)
        price_stream.on_next(100)
